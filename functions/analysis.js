...
export async function onRequestGet(){
 const type="analysis", title="บทวิเคราะห์ฟุตบอล", desc="รวมบทวิเคราะห์ก่อนการแข่งขันจาก HN FOOTBALL SCORE เน้นภาพรวม ฟอร์มทีม จุดสำคัญ และแนวโน้มรูปเกม", canonical=`${SITE}/analysis`;
