...
(async()=>{
  ...
  try{
    ...
    const schema={"@context":"https://schema.org","@type":a.content_type==="news"?"NewsArticle":"Article","headline":a.title,"description":desc,"image":image?[image]:[],"datePublished":a.publish_at||a.published_at||a.created_at,"dateModified":a.updated_at||a.publish_at||a.created_at,"author":{"@type":"Person","name":a.author||"บอส สิทธิกร","url":`${SITE}/about.html#author`},"publisher":{"@type":"Organization","name":"HN FOOTBALL SCORE","url":SITE,"logo":{"@type":"ImageObject","url":`${SITE}/assets/icons/icon.svg`}},"mainEntityOfPage":{"@type":"WebPage","@id":canonical}};
