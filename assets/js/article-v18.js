...
(async()=>{
  ...
  try{
    ...
    const defaultImage=`${SITE}/assets/og-image.jpg`;
    const coverImage=a.image_url||a.cover_image||a.og_image||defaultImage;
    const shareImage=a.og_image&&a.og_image!==defaultImage?a.og_image:coverImage;
    ...
    const twImg=document.querySelector('meta[name="twitter:image"]')||document.head.appendChild(Object.assign(document.createElement("meta"),{name:"twitter:image"})); twImg.content=shareImage;
    document.querySelector('link[rel="canonical"]').href=canonical;
    ["og:title","og:description","og:url","og:image"].forEach(p=>{
      const n=document.querySelector(`meta[property="${p}"]`);
      if(n)n.content=({["og:title"]:a.og_title||title,["og:description"]:a.og_description||desc,["og:url"]:canonical,["og:image"]:shareImage})[p];
    });
